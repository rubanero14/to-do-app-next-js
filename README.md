...
- Create New Collection, name your collection as `todos`, and  2 new fields for `title` and `description` respectively
- You may run the project now to test it locally
